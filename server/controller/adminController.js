...
import generateStudentPDF from '../utils/generateStudentPDF.js'; // Ensure the correct path
...
export const addStudent = async (req, res) => {
  try {
    ...
    // Generate the PDF
    const pdfBytes = await generateStudentPDF(newStudent);
    const pdfBase64 = Buffer.from(pdfBytes).toString('base64');
    newStudent.pdf = pdfBase64;
